'use strict';
// Feature: discovery preferences (spec 01 — age range, max distance, shared
// interests). Guards: each filter narrows the deck correctly, the empty result
// state, and reset back to defaults.
//
// Candidate pool ground truth (excluding seeded matches maya/jonah):
//   priya 27/3km, theo 29/5, amara 25/8, luca 31/2, noor 26/12, felix 28/6,
//   ivy 24/9, mateo 30/4, sasha 27/15, wren 26/7, daniel 33/10, zoe 25/5
